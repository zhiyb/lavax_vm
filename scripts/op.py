...
op = {
    ...
    0x29: ("lnot",         PARAM_NONE,    1, 1),
    0x2a: ("mul",          PARAM_NONE,    2, 1),
    0x2b: ("div",          PARAM_NONE,    2, 1),
    0x2c: ("mod",          PARAM_NONE,    2, 1),
    0x2d: ("lshift",       PARAM_NONE,    2, 1),
    0x2e: ("rshift",       PARAM_NONE,    2, 1),
    ...
    0x3e: ("push_frame",   PARAM_ADDR_U8, 0, 0),
    0x3f: ("pop_frame",    PARAM_NONE,    0, 0),
    ...
    0x9c: ("isalpha",      PARAM_NONE,    1, 1),
    0xa6: ("strcat",       PARAM_NONE,    2, 0),
    ...
    0xba: ("deletefile",   PARAM_NONE,    1, 1),
    0xbb: ("gettick",      PARAM_NONE,    0, 1),
    0xbc: ("checkkey",     PARAM_NONE,    1, 1),
    0xbe: ("crc16",        PARAM_NONE,    2, 1),
    0xbf: ("encrypt",      PARAM_NONE,    3, 0),
    0xc2: ("gettime",      PARAM_NONE,    1, 0),
    0xc5: ("xdraw",        PARAM_NONE,    1, 0),
...
op_pdata = {
    ...
    PARAM_STR:     lambda d, ram_size: f'"{d.decode("GBK")}"',
